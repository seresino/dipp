...
declare module '$env/static/private' {
	...
	export const VITE_DATABASE_HOST: string;
	export const VITE_DATABASE_USERNAME: string;
	export const VITE_DATABASE_PASSWORVITE_D: string;
	export const VITE_DATABASE_NAME: string;
	...
	export const THEFUCK_INSTANT_MODE: string;
	export const NVM_INC: string;
	export const PAGER: string;
	export const HOMEBREW_PREFIX: string;
	export const VSCODE_GIT_ASKPASS_MAIN: string;
	export const PS1: string;
	export const THEFUCK_OUTPUT_LOG: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		VITE_DATABASE_USERNAME: string;
		VITE_DATABASE_PASSWORVITE_D: string;
		...
		ZSH: string;
		LSCOLORS: string;
		THEFUCK_INSTANT_MODE: string;
		NVM_INC: string;
		PAGER: string;
		HOMEBREW_PREFIX: string;
		VSCODE_GIT_ASKPASS_MAIN: string;
		PS1: string;
		THEFUCK_OUTPUT_LOG: string;
